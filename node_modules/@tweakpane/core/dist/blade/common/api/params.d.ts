...
import { BaseInputParams, BaseMonitorParams, BaseParams, ListParamsOptions, NumberTextInputParams, PickerLayout, PointDimensionParams } from '../../../common/params.js';
...
export interface NumberInputParams extends BaseInputParams, NumberTextInputParams {
    options?: ListParamsOptions<number>;
}
export interface Point2dYParams extends PointDimensionParams {
    inverted?: boolean;
}
export interface Point2dInputParams extends BaseInputParams, PointDimensionParams {
    expanded?: boolean;
    picker?: PickerLayout;
    x?: PointDimensionParams;
    y?: Point2dYParams;
}
export interface Point3dInputParams extends BaseInputParams, PointDimensionParams {
    x?: PointDimensionParams;
    y?: PointDimensionParams;
    z?: PointDimensionParams;
}
export interface Point4dInputParams extends BaseInputParams, PointDimensionParams {
    x?: PointDimensionParams;
    y?: PointDimensionParams;
    z?: PointDimensionParams;
