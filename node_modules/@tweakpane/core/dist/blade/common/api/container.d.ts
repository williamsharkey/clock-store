...
export declare function addButtonAsBlade(api: ContainerApi, params: ButtonParams): ButtonApi;
export declare function addFolderAsBlade(api: ContainerApi, params: FolderParams): FolderApi;
export declare function addTabAsBlade(api: ContainerApi, params: TabParams): TabApi;
